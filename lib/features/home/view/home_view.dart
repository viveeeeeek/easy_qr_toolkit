              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  Visibility(
                    ...
                    maintainState: true,
                    child: const ModernQRInputCard(),
                  ),
                  if (generatorState.data.isNotEmpty) ...[
                    // Dynamic spacing based on keyboard
                    (isKeyboardOpen ? 16.h : 32.h),

                    // The main QR Card - animate size if needed, but it should naturally move up
                    AnimatedContainer(
                        duration: const Duration(milliseconds: 300),
                        // Removed extra top padding to reduce gap above QR
                        child: GeneratedQRCard(isCompact: isKeyboardOpen)
                    ),
